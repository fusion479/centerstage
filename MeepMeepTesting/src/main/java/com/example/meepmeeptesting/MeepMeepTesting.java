...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(utils.reflectY(Positions.vectorToPose(Positions.GENERAL.BACKDROP_MID, Math.toRadians(0))))
                ...
                .lineToX(utils.reflectY(Positions.modifyPose(Positions.GENERAL.STACK_ONE, Constants.ROBOT_LENGTH / 2, 0)).x).build());
