...
public class Deposit extends Mechanism {
    public static double ACCEPTING_POS = 0 + 0.15;
    public static double IDLE_POS = .61 + 0.15;
    public static double READY_POS = 0.3 + 0.15;
    public static double SCORE_POS = 0.62 + 0.15;
    public static double AUTO_INIT_POS = 0.9 + 0.15;
    public static double AUTO_STACK_POS = .15 + 0.15;
