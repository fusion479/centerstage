...
import org.firstinspires.ftc.teamcode.subsystems.camera.Pipeline;
...
public class TwoPlusZero extends CommandOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action INITAL_PATH = this.camera.getRegion() == 1 ? this.TRAJECTORIES.LEFT_SPIKEMARK : this.camera.getRegion() == 2 ? this.TRAJECTORIES.MID_SPIKEMARK : this.TRAJECTORIES.RIGHT_SPIKEMARK;
