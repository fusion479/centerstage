...
public class Robot {
    ...
    public void Robot(final HardwareMap hwMap) {
    ...
    public void configureCommands() {
        // CLIMBER COMMANDS
        this.gamepad.getGamepadButton(GamepadKeys.Button.X).whenPressed(new ExtendClimber(this.climber));
        this.gamepad.getGamepadButton(GamepadKeys.Button.A).whenPressed(new RetractClimber(this.climber));
    }
}
