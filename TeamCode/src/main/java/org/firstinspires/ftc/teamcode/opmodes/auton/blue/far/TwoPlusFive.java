...
public class TwoPlusFive extends CommandOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        backdropToStack = region == 1 ? GENERAL.LEFT_BACKDROP_TO_STACK(this.robot.getDrive().pose) : region == 2 ? GENERAL.MID_BACKDROP_TO_STACK(this.robot.getDrive().pose) : GENERAL.RIGHT_BACKDROP_TO_STACK(this.robot.getDrive().pose);
